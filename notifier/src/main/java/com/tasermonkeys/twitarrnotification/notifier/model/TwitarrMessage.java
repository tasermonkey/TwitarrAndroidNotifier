...
public class TwitarrMessage extends TwitarrModel {
    private final String author;
    private final String displayName;
    private final String text;
    private final Date timestamp;

    public TwitarrMessage(String id, String author, String displayName, String text, Date timestamp) {
        super(id);
        this.author = author;
    ...
    public static TwitarrMessage fromJsonObject(JSONObject input) {
        try {
            return new TwitarrMessage(input.getString("id"),
